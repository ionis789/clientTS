    ...
    switch (action.type) {
        ...
        case SELECT_ROOM: {
            return {
                ...
                selectedRoomData: state.allRoomsData.find((r) => r.roomID === action.selectedRoomID),
            };
        }
...
export const initiatePotentialRoomTC = (potentialUserCompanionID, potentialUserCompanionName) => (dispatch) => {
    dispatch(initiateRoom(potentialUserCompanionID, potentialUserCompanionName));
...
export const createRoomTC = (loggedUserID, userCompanionID) => async (dispatch) => {
...
export const initiateRoom = (potentialUserCompanionID, potentialUserCompanionName) => ({
    type: INITIATE_ROOM,
